...
//        System.out.println(name.charAt(10)); // StringIndexOutOfBoundsException
        ...
        // 4. equals()
        System.out.println(name.equals("KrishnaVamshi"));

        // 5. equalsIgnoreCase()
        System.out.println(name.equalsIgnoreCase("KrishnaVamshi"));
        ...
        String name4 = "Krishna@Vamshi@123";
